...
- Assistentes de Contas a pagar:
    ...
    - get_due_bills: Lista as contas que vencem nos próximos X dias.
    - get_due_bills_today: Lista as contas que vencem hoje.
    - get_bills_today: Lista todas as contas pagas da data de hoje.
    ...
    - deletar_conta: Remove um lançamento.
    - value_total_by_category: Total a pagar por categoria.
    - get_transactions_by_date: Lista os lançamentos por data específica.
